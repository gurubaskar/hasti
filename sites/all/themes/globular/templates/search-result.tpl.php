...
<div class="boxListItemGrid productItem PLP <?php print $classes; ?>"<?php print $attributes; ?>>
  <ul class="displayList productItemList PLP">
   ...
   <!--   <span><a title="Share on Facebook" class="fb_share" target="_blank" href="#" rel="me"></a></span>
      ...
      <span><a title="Share on Pinterest" class="pinit_share pin-it-button" target="_blank" href="#" count-layout="horizontal">
      </a></span>
    ...
    <li class="plp_hover_addtowish action addToWishlist plpAddToWishlist" id="js_addToWishlist_Wishlistbtn_PLP_<?php echo $product->product_id ?>" style="display: none;">
      <div id="plpQuicklook_" class="js_plpQuicklook plpQuicklookIcon">
        ...
        <!-- <a href="javaScript:void(0);" title="Quick Look" onclick="displayActionDialogBoxQuicklook('plpQuicklook_',this,'#');"><img style="" alt="Fashion Women Casual Patialas -" src="<?php echo current_theme_path() ?>/images/quickLook.png"></a> -->
      </div>
    </li>
