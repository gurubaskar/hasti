...
<div class="col-xs-12 col-sm-8 col-md-9 myaccount-right returnOrderItem">
	...
	<div id="past-orders" class="tab-content">
		<?php 
			...
			?>
			<div class="cartbox">
				Order Id: <span><a href="<?php echo url('account/orders-details/' . $order['orderId']) ?>"><?php echo $order['orderId'] ?></a></span>
				Return Order Id: <span><a href="<?php echo url('account/orders-details/' . $order['orderId']) ?>"><?php echo $order['returnId'] ?></a></span>
