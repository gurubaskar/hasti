          ...
          <div id="shipping">
            ...
            <div class="icon-wrap">
              <div class="icon-container">
                <ul>
                  <li>
                    <a href="<?php echo url('print_invoice.php')?>?orderid=<?php echo $order['orderId'] ?>" target="_blank"><img src="<?php echo current_theme_path();?>/images/print.png" id="print"></a>
                    <a href="<?php echo url('print_invoice.php')?>?orderid=<?php echo $order['orderId'] ?>" target="_blank">Print</a>
                  </li>
                  <li>
