      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12" id="homepage">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 row1">
            <div class="row mright">
              <div class="col-xs-6 col-sm-3 col-md-3 pright">
                <img src="<?php print current_theme_path();?>/images/h-img1.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-6 col-sm-3 col-md-3 pright">
                <img src="<?php print current_theme_path();?>/images/h-img2.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-6 col-sm-3 col-md-3 pright">
                <img src="<?php print current_theme_path();?>/images/h-img3.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-6 col-sm-3 col-md-3 pright lastcol">
                <img src="<?php print current_theme_path();?>/images/h-img4.jpg"  class="img-responsive"/>
                <span class="video">
                  <img src="<?php print current_theme_path();?>/images/h-img5.jpg"  class="img-responsive"/>
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 row2">
            <div class="row mright">
              ...
              <div class="col-xs-12 col-sm-6 col-md-6 pright bigimg">
                <img src="<?php print current_theme_path();?>/images/h-row-img3.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-12 col-sm-3 col-md-3 pright">
                <img src="<?php print current_theme_path();?>/images/h-row-img4.jpg"  class="img-responsive"/>
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 row3">
            <div class="row mright">
              <div class="col-xs-12 col-sm-6 col-md-6 pright bigimg">
                <img src="<?php print current_theme_path();?>/images/h-row2-img1.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-6 col-sm-3 col-md-3 pright bigimg">
                <img src="<?php print current_theme_path();?>/images/h-row2-img2.jpg"  class="img-responsive"/>
              </div>
              <div class="col-xs-6 col-sm-3 col-md-3 pright lastcol">
                <img src="<?php print current_theme_path();?>/images/h-row2-img3.jpg"  class="img-responsive"/>
                <span class="video">
                  <img src="<?php print current_theme_path();?>/images/h-row2-img4.jpg"  class="img-responsive"/>
                </span>
              </div>
            </div>
          </div>
